/*
  ...
  - Added the required column `smsenabled` to the `UserSetting` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "public"."UserSetting" ADD COLUMN     "smsenabled" BOOLEAN NOT NULL,
